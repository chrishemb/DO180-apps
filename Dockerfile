...
RUN groupadd -r nexus -f -g 1001 && useradd -u 1001 -r -g nexus -m -d ${NEXUS_HOME} -s /sbin/nologin -c "Nexus User" nexus && chown -R nexus:nexus ${NEXUS_HOME} && chmod -R 755 ${NEXUS_HOME}
USER nexus
